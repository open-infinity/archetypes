...
import it.pkg.core.annotation.AuditTrail;
import it.pkg.core.annotation.Log;
import it.pkg.core.aspect.ArgumentStrategy;
import it.pkg.core.exception.AbstractCoreException;
import it.pkg.core.exception.ApplicationException;
import it.pkg.core.exception.BusinessViolationException;
import it.pkg.core.exception.SystemException;
import it.pkg.domain.entity.Product;
import it.pkg.domain.service.ProductService;
import it.pkg.web.model.ProductModel;
import it.pkg.web.support.SerializerUtil;
import it.pkg.web.support.ServletUtil;
